...
%>
							    <tr>
									<td id="tbody">
										<%=i+1 %>
										<input type="checkbox" name="checkItem" value="<%=item.getId() %>" class="items" style="display:none;">
									</td>
...
%>
								...
								<tr>
									<td colspan="4" style="text-align:center; border:none;">
										<input type="button" class="button special" value="구매하기">
										<input type="button" class="button alt" value="이전으로">
<%
	}
%>
									</td>
