...
<form method="post" action="db_register.jsp" name="change_information">
	<div class="row uniform">
	
	
		
		<div class="12u 12u$(xsmall)">
			<input type="text" name="email" id="email" value="plare2019@naver.com" placeholder="이메일 형식" disabled />
		</div>
		
		<div class="12u 12u$(xsmall)">
			<input type="password" name="pw" id="pw" value="" placeholder="비밀번호 20자 이하, 정보를 수정하시려면 비밀번호를 입력하시길 바랍니다" />
		</div>
		...
		<div class="8u 12u$(xsmall)">
			<input type="text" name="name" id="name" value="플레어" placeholder="" />	
		</div>
		...
		<div class="8u 12u$(xsmall)">
			<input type="text" name="referrer" id="referrer" value="플레어" placeholder="추천인 닉네임" disabled/>
		</div>
		
	</div>
</form>
	<div class="12u$ 12u$(xsmall)">
		<a href="../login" class="button alt">수정완료</a>
	</div>
